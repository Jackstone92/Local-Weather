...
$(document).ready(function(){
	...
	var api = "http://api.openweathermap.org/data/2.5/find?lat=55.5&lon=37.5&cnt=10&appid=c17738cc32a8abccde8fa0af46663f07";
	var jsonAPI = "http://ip-api.com/json";
	var openWeatherKey='c17738cc32a8abccde8fa0af46663f07';
	var city='';
	var country='';
	var tempCelsius='';
	var tempFahrenheit='';
	...
	$.getJSON(jsonAPI,function(data){
	  ...
	  country=data.country;
		...
		myLocation = "http://api.openweathermap.org/data/2.5/weather?lat="+lat+"&lon="+lon+"&appid=c17738cc32a8abccde8fa0af46663f07";
	 // 	updateWeather();

		$.getJSON(myLocation, function(data2) {
			windSpeed = data2.wind.speed;
			$('.windSpeed').html("Windspeed : "+windSpeed+" m/s");
			tempCelsius = Math.floor(data2.main.temp -273.15);
			tempFahrenheit = tempCelsius * 9 / 5 + 32;
			tempCelsius += ' &#8451;';
			tempFahrenheit +=' &#8457;';
	    $('#temperature').html(tempCelsius);
			var prefix = 'wi wi-';
			var code = data2.weather[0].id;
	...
	function myTimer() {
	  var d = new Date();
	  d.setTime(d.getTime() + (d.getTimezoneOffset()+utcOffset));
	...
	$('input[name=tempUnit]').change(function() {
	  ...
	  $('#temperature').animate({'opacity': 0}, 400, function () {
	  	$(this).html(selectedTemp);
